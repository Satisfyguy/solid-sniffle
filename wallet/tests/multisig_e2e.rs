...
async fn test_wallet_connections() {
    ...
    info!("📡 Testing connection to wallet 1...");
    client1
        .check_connection()
        .await
        .expect("Wallet 1 connection failed");
    info!("✅ Wallet 1 connected");

    // Test connection to wallet 2
    info!("📡 Testing connection to wallet 2...");
    client2
        .check_connection()
        .await
        .expect("Wallet 2 connection failed");
    info!("✅ Wallet 2 connected");

    // Test connection to wallet 3
    info!("📡 Testing connection to wallet 3...");
    client3
        .check_connection()
        .await
        .expect("Wallet 3 connection failed");
    info!("✅ Wallet 3 connected");
...
async fn test_multisig_prepare() {
    ...
    info!("📝 Wallet 1: Preparing multisig...");
    let info1 = client1
        .prepare_multisig()
        .await
    ...
    info!("📝 Wallet 2: Preparing multisig...");
    let info2 = client2
        .prepare_multisig()
        .await
    ...
    info!("📝 Wallet 3: Preparing multisig...");
    let info3 = client3
        .prepare_multisig()
        .await
...
async fn test_multisig_make() {
    ...
    info!("🔐 Wallet 1: Making 2-of-3 multisig...");
    let make1 = client1
        .make_multisig(
            2,
    ...
    info!("✅ Wallet 1 multisig address: {}", make1.address);
    ...
    info!("🔐 Wallet 2: Making 2-of-3 multisig...");
    let make2 = client2
        .make_multisig(
            2,
...
async fn test_multisig_export_import() {
    ...
    // Round 1: Export
    info!("📤 Round 1: Exporting multisig info from all wallets...");
    ...
    info!("✅ Round 2 exports complete\n");

    // Round 2: Import
    info!("📥 Round 2: Importing multisig info...");
    ...
    info!("✅ Wallet 1: Imported {} outputs", import1_r2.n_outputs);
...
async fn test_complete_multisig_setup() {
    ...
    let info3 = client3
        ...
        .await
        .expect("Wallet 3 prepare failed");
    info!("  ✅ Wallet 3 prepared\n");

    // ━━━ STEP 2: Make Multisig ━━━
    info!("📋 STEP 2/6: Make Multisig (2-of-3)\n");
    let make1 = client1
        .multisig()
        .make_multisig(
            2,
    ...
    assert_eq!(make1.address, make2.address);
    assert_eq!(make2.address, make3.address);
    info!("  🎯 Shared multisig address: {}\n", make1.address);

    // ━━━ ROUND 1: Export/Import ━━━
    info!("📋 ROUND 1: Synchronization (Export → Import)\n");
    ...
    info!("📋 ROUND 2: Final Synchronization (Export → Import)\n");
    ...
    // ━━━ VERIFICATION ━━━
    info!("📋 VERIFICATION: Checking multisig status\n");
    ...
    info!("  ✅ Wallet 1: multisig = {}", is_multisig1);
    info!("  ✅ Wallet 2: multisig = {}", is_multisig2);
    info!("  ✅ Wallet 3: multisig = {}", is_multisig3);

    info!("\n═══════════════════════════════════════════════════════");
    info!("🎉 SUCCESS: 2-of-3 multisig wallet fully operational!");
    info!("═══════════════════════════════════════════════════════\n");
}
