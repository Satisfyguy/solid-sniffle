...
use server::handlers::{auth, cart, escrow, frontend, listings, messages, monitoring, multisig_challenge, orders, reputation, reputation_ipfs};
...
async fn main() -> Result<()> {
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .route("/vendor/dashboard", web::get().to(frontend::show_vendor_dashboard))
            ...
            .service(
                web::scope("/api")
                    ...
                    .service(listings::get_vendor_dashboard_stats)
