document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async function(event) {
        ...
        const listingId = pathParts[pathParts.length - 2]; // Extract listing ID from URL
        ...
        resultDiv.innerHTML = '<p style="color: #888;">UPDATING...</p>';
        ...
        try {
            ...
            if (response.ok) {
                resultDiv.innerHTML = `<p style="color: #22c55e;">SUCCESS! Listing updated.</p><pre>${JSON.stringify(responseData, null, 2)}</pre>`;
            } else {
